...
type ConnectionConfig = {
  ...
  authType: 'AAD' | 'AccessKey' | 'AccountKey' | 'AccountManagedIdentity' | 'AgentUserImpersonation' | 'AgenticIdentityToken' | 'AgenticUser' | 'ApiKey' | 'Basic' | 'CustomKeys' | 'DelegatedSAS' | 'DeveloperConnection' | 'ManagedIdentity' | 'None' | 'OAuth2' | 'PAT' | 'ProjectManagedIdentity' | 'RegistryIdentity' | 'SAS' | 'ServicePrincipal' | 'UserEntraToken' | 'UserTokenAndProjectManagedIdentity' | 'UsernamePassword'
  ...
  @description('Token audience for UserEntraToken / AgenticIdentityToken auth types (optional)')
  audience: string?
