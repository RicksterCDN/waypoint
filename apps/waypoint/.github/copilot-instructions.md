...
This is the Caldova Waypoint application runtime: a FastAPI API, React Router web app, and Aspire AppHost. Follow these guidelines when working with this codebase.
